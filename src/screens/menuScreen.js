    ...
    getMenuList() {
        AsyncStorage.getItem('token')
            .then((value) => {
                ...
                const category = this.props.navigation.state.params.selectedCategoryId;
                axios
                    .get(apiConfig.baseUrl + 'User/GetMenuList?categoryId=' + category + '', {
                        headers: {
    ...
    render() {
        return (
            <Background >
                ...
                <BackButton goBack={() => this.props.navigation.goBack(null)} />
                <View style={{ width: width }}>
                    ...
                    {/* <View style={styles.container} style={(this.state.bannerItems.length < 6 && this.state.MenuList.length < 9) ? styles.margin100 : styles.margin0}>
                        <Snackbar
                            visible={this.state.snackIsVisible}
                            onDismiss={() => this.setState({ snackIsVisible: false })}
                            action={{
                                label: 'Dismiss',
